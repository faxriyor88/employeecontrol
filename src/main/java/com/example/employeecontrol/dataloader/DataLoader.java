...
//            District qordis1 = new District("Янгибозор",xorazm);District qordis2 = new District("Янгиариқ", xorazm);
//            District qordis3 = new District("Урганч ",xorazm);District qordis4 = new District("Шовот", xorazm);
//            District qordis5 = new District("Қўшкўпир ",xorazm);District qordis6 = new District("Хива", xorazm);
//            District qordis7 = new District("Ҳазорасп ",xorazm);District qordis8 = new District("Хонқа", xorazm);
//            District qordis9 = new District("Гурлан ",xorazm);District qordis10 = new District("Боғот", xorazm);
...
//            Company company1 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Тошкент вилоят кенгаши", region4);
//            Company company2 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Андижон вилоят кенгаши", region5);
//            Company company4 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Фарғона вилоят кенгаши ", region5);
//            Company company5 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Наманган вилоят кенгаши	 ", region5);
//            Company company6 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Сирдарё вилоят кенгаши ", region5);
//            Company company7 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Жиззах вилоят кенгаши ", region5);
//            Company company8 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Самарқанд вилоят кенгаши ", region5);
//            Company company9 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Бухоро  вилоят кенгаши ", region5);
//            Company company10 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Қашқадарё вилоят кенгаши ", region5);
//            Company company11 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Сурхондарё вилоят кенгаши ", region5);
//            Company company12 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Навоий вилоят кенгаши ", region5);
//            Company company13 = new Company("Ўзбекистон Республикаси касаба уюшмалари Федерацияси Хоразм вилоят кенгаши ", region5);
